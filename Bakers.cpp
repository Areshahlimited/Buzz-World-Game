...
int main() {
	...
	head = NULL;
	//insertend(1, "Cookies", 8, 2);
	//insertend(2, "Coffee  ", 50, 4.50);
	//insertend(3, "Brownies   ", 40, 3);
	//insertend(4, "Hot Pudding  ", 34, 3);
	//insertend(5, "Pandecoco  ", 30, 1.50);
...
mainmenu:
	...
	confirm:
		...
		br(2); pre(4); 
		//echo("Please Choose From List "); br(2); Sleep(300);
...
void pwellcome() {
	...
	char welcome2[50] = " TO";
	char welcome3[50] = " BAKERY MANAGEMENT";
