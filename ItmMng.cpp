...
void login()
{
	...
	do
	{
		...
		{
			printf("  \n\n\n       WELCOME TO ITEM MANAGEMENT SYSTEM !!!! LOGIN IS SUCCESSFUL");
...
main:
	...
	printf("                                                                                          ");
	printf("\n\t\tPress <1> Add Items");
	printf("\n\t\tPress <2> Delete Items");
	printf("\n\t\tPress <3> Search Items");
	printf("\n\t\tPress <4> Read Items");
	printf("\n\t\tPress <5> Edit Items");
	printf("\n\t\tPress <6> Exit!");
...
void add_item()
{
	...
	do
	{
		...
		do
		{
			...
			{
				printf("\n\tYou Cannot Enter the price limit $.Re-Enter.");
			}
