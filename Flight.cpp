...
public:
    ...
    int select_flighti()
    {
        ...
        case 1:
            ...
            strcpy_s(tojdi, "10:00");
            strcpy_s(tojai, "14:05");
            break;
        case 2:
            cout << "\nFlight selected:" << endl;
            cout << "Zoom" << endl;
            ...
            strcpy_s(tojdi, "14:00");
            strcpy_s(tojai, "18:05");
            break;
        case 3:
            cout << "\nFlight selected:" << endl;
            cout << "Fly Away" << endl;
            strcpy_s(f_i, "Fly Away");
            cout << "Departure Time : 18:00" << endl;
            cout << "Arrival Time: 22:05" << endl;
            strcpy_s(tojdi, "18:00");
            strcpy_s(tojai, "22:05");
            break;
        default:
