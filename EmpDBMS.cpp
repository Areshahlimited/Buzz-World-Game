...
public:
    ...
    void options(void) {
        ...
        while (true) {
            ...
            cout << "\n";
            cout << "\n\t\t------------------------------------------------";
            cout << "\n\t\tENTER   1:   Display Employees List";
            cout << "\n\t\t------------------------------------------------";
            cout << "\n\t\tENTER   2:   View Indvidual Emplyee Detail";
            cout << "\n\t\t------------------------------------------------";
            cout << "\n\t\tENTER   3:   Update Existing Employee Details";
            cout << "\n\t\t------------------------------------------------";
            cout << "\n\t\tENTER   4:   Add new Employee Detail";
            cout << "\n\t\t------------------------------------------------";
            cout << "\n\t\tENTER   5:   Delete Employee Record";
            cout << "\n\t\t------------------------------------------------";
